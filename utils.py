...
def interactive_segmentation(cv_im, box):
    ...
    file_path = "dumb/{}{}{}.png".format(int(time),
                                         np.randint(0, 1e3),
                                         np.randint(1e3, 1e6)
                                         )
...
def wrap_segmentation(base64_im, box):
    return encode64_im(interactive_segmentation(readb64(base64_im), box))
